            ...
            {displayInput &&
                <form method='POST' action='#'>
                    ...
                    <div className='mb-3'>
                        ...
                        <textarea className='form-control' name="" id="submitReviewDescription" placeholder='Optional' rows={3} onChange={e => setReviewDescription(e.target.value)}>

                        </textarea>

                        <div>
                            <button type='button' className='btn btn-primary mt-3' onClick={()=>props.submitReview(starInput,reviewDescription)}>Submit</button>
                        </div>
                    </div>
